...
namespace crudBodega.Controllers
{
    public class BebidumsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Idbebida,Nombrebebida,Valorbebida")] Bebidum bebidum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Idbebida,Nombrebebida,Valorbebida")] Bebidum bebidum)
        {
